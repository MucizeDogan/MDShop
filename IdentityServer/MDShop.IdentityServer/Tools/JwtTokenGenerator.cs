...
namespace MDShop.IdentityServer.Tools {
    public class JwtTokenGenerator {
        public static TokenResponseViewModel GenerateToken(GetCheckAppUserViewModel model) { //Identityden otomatik gelen token ı manuel oluşturmayı deneyeceğiz, öğrenmek için
